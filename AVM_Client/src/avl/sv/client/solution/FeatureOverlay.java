...
public class FeatureOverlay extends javax.swing.JFrame implements ImageViewerPlugin {
    ...
    public FeatureOverlay(ImageViewer imageViewer, ArrayList<Sample> samples, String featureNames[], String title) {
        initComponents();
        ...
        for (int row = 0; row < jTableClassifierResults.getRowCount(); row++) {
            ...
            if (visible) {
                ...
                for (Sample s : samples) {
                    ...
                    Rectangle rPaint = new Rectangle(r.x, r.y , tileDim, tileDim);
                    g.setColor(c);
                    g.fill(rPaint);
                }
            }
