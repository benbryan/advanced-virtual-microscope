...
public class KernelDouble implements Cloneable {
    private int  width;
    private int  height;
    private int  xOrigin;
    private int  yOrigin;
    ...
    /**
     * Constructs a <code>Kernel</code> object from an array of doubles.
     ...
     *         <code>height</code>
     */
    public KernelDouble(int width, int height, double data[]) {
        this.width  = width;
        this.height = height;
