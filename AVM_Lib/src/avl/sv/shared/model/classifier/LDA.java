...
/**
 * Copyright (c) 2010, Dr. Wolfgang Lenhard, Psychometrica.de All rights
 * reserved.
 *
 * This code serves for calculating a linear discriminant analysis (LDA) and it
 * is based on the tutorial of Kardi Teknomo
 * (http://people.revoledu.com/kardi/tutorial/LDA/index.html). You will need
 * JAMA (A Java Matrix Package; http://math.nist.gov/javanumerics/jama/) to run
 * this routines.
 *
 ...
 *
 * Quotation: Lenhard, W. (2010). Realisation of Linear Discriminant Analysis in
 * Java. Bibergau: Psychometrica.
 *
 *
 */
...
public class LDA {
     ...
     *
     * @param data The data as double array. The array must have the same size
     * as the group array
     * @param group The membership in the different groups
     * @param p Set to true, if the probability estimation should be based on
     * the real group sizes (true), or if the share of each group should be
     * equal
     */
